...
barrier()
{
  ...
  bstate.nthread++;
  // if we use while then if the thread is weaking up, then it may see bstate.nthread == 0, so it will continue call pthread_cond_wait, then the program will block forever.
